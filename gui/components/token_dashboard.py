...
class TokenBudgetSettingsWidget(QFrame):
    ...
    def _load_persisted_settings(self):
        try:
            ...
            if saved_settings:
                self.max_tokens_input.setValue(saved_settings.get('max_target_tokens', 256*1024))
                self.chunk_size_input.setValue(saved_settings.get('chunk_size_tokens', 8*1024))
                self.overlap_input.setValue(saved_settings.get('overlap_tokens', 2*1024))
                self.preserve_input.setValue(saved_settings.get('preserve_recent_tokens', 4*1024))
                
                streaming_processor.max_target_tokens = saved_settings.get('max_target_tokens', 256*1024)
                streaming_processor.chunk_size_tokens = saved_settings.get('chunk_size_tokens', 8*1024)
                streaming_processor.overlap_tokens = saved_settings.get('overlap_tokens', 2*1024)
                streaming_processor.preserve_recent_tokens = saved_settings.get('preserve_recent_tokens', 4*1024)
    ...
    def setup_ui(self):
        ...
        self.max_tokens_input.setRange(1024, 256*1024)
        self.max_tokens_input.setValue(256*1024)
        ...
        self.chunk_size_input.setRange(512, 8*1024)
        self.chunk_size_input.setValue(8*1024)
        ...
        self.overlap_input.setRange(512, 2*1024)
        self.overlap_input.setValue(2*1024)
        ...
        self.preserve_input.setRange(512, 4*1024)
        self.preserve_input.setValue(4*1024)
